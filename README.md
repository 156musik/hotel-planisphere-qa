...
├── plans/
│   └── research-plans-page.md      # プラン一覧画面の事前調査
└── header-footer/
    └── research-header-footer.md   # ヘッダー・フッターの事前調査
...
これらを選択した理由は、ユーザーがログイン失敗になる場合、ログイン情報の入力ミスによるところが多いからではないかと推測しているからです。
